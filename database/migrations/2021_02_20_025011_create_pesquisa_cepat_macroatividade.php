...
class CreatePesquisaCepatMacroatividade extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('TBL_PRODUTIVIDADE_CEPAT_TBL_MACROPROCESSOS', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('TBL_PRODUTIVIDADE_CEPAT_TBL_MACROPROCESSOS');
    }
}
