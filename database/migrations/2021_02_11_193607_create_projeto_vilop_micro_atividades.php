...
class CreateProjetoVilopMicroAtividades extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('TBL_PRODUTIVIDADE_VILOP_TBL_MICROPROCESSOS', function (Blueprint $table) {
            $table->bigIncrements('idMicro');
            $table->integer('IdMacroProcesso')->references('IdMacro')->on('PRODUTIVIDADE_VILOP_TBL_MACROPROCESSOS');
    ...
    {
        Schema::dropIfExists('TBL_PRODUTIVIDADE_VILOP_TBL_MICROPROCESSOS');
    }
}
