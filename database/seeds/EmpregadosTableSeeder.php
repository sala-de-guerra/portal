...
class EmpregadosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('TBL_EMPREGADOS')->insert(['matricula' => 'c079436','nomeCompleto' => 'VLADIMIR PEREIRA DE LEMOS','primeiroNome' => 'VLADIMIR','dataNascimento' => '30416','codigoFuncao' => '2058','nomeFuncao' => 'ASSISTENTE SENIOR','codigoLotacaoAdministrativa' => '7257','nomeLotacaoAdministrativa' => 'GI ALIENAR BENS MOVEIS IMOV SAO PAULO,SP','codigoLotacaoFisica' => 'NULL','nomeLotacaoFisica' => 'NULL','created_at' => '2019-03-18 21:38:08.663','updated_at' => '2019-05-21 13:34:57.553',]);
