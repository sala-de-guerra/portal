...
<div class="row mb-2">
    ...
    <div class="col">
        <ol class="breadcrumb float-right">
            <li class="breadcrumb-item active"> <i class="fa fa-map-signs"></i> <a href="/fornecedores/controle-despachantes"> Fornecedores</a> </li>
            <li class="breadcrumb-item active"> Controle Leiloeiros</li>
        </ol>
    </div>
</div><br>
                    ...
                    <div class="px-2" style="overflow-y: auto; height: 100%;">
                        ...
                        <div>
                            ...
                            <div class="form-group collapse multi-collapse LeiloeiroEmgea ">
                                ...
                                <input type="text" name="dataVencimentoContrato" id="datepicker" class="form-control datepicker" autocomplete="off" placeholder="Selecione no calendário">
                            </div>
