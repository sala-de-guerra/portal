...
<div class="modal fade" id="modalTeste" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg mda modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background: linear-gradient(to right, #4F94CD , #63B8FF);">
          <h5 style="color: white;" class="modal-title" id="exampleModalLabel">Histórico de Atende</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <table id="tblHistoricoAtende" class="table table-bordered table-striped ">
                <thead>
                    <tr>
                        <th>Data</th>
                        <th>status</th>
