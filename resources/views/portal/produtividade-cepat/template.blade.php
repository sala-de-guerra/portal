...
<head>
    ...
    <title>Produtividade Cepat</title>
...
<body class="sidebar-mini layout-fixed layout-navbar-fixed "  >
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand-md navbar-primary navbar-dark">
            ...
            <form class="form-inline m-0" id="buscaCGCcepat" action="" method="post">
                            {{ csrf_field() }}
...
@yield('menu-lateral')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active"> <i class="fa fa-map-signs"></i> <a href="/produtividade-cepat"> Produtividade CEPAT</a> </li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="d-inline justify-content-right">
                            <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="Fernanda Naomi Hoota Okubo ,    Rafael Pimentel Gonçalves ,    Vladimir Pereira de Lemos"><i class="fas fa-info-circle"></i>
                            Desenvolvedores
                            </button>
                        </div>
                    </div>
        ...
        <script>
            ...
            $('#buscaCGCcepat').submit( function(e) {
            e.preventDefault();
            var $input = $(this).find('[name=numeroCGC]');
            window.location = `/produtividade-cepat/${$input.val()}`
            })
