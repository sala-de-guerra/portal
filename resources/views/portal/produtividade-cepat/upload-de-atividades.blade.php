                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p class="text-justify"><b>1º -</b> Faça o Download da planilha com a Lista GD Indicadores de Produtividade-> <a href="/download/indicadores_produtividade_cepat.xlsx"><span style="color: green;"><b>Clique aqui para baixar</b></a></span><br>
                                        ...
                                        <form method="POST" action="/produtividade-cepat/carga-em-lote/envia" enctype="multipart/form-data">
                                            {{ csrf_field() }}
...
$(document).ready(function(){
        $.getJSON('/produtividade-cepat/atividades-em-lote/dados', function(dados){
