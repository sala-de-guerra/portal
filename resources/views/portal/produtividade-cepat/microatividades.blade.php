...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <form action="/produtividade-cepat/cria-micro-atividade/{{$idMacro ?? ''}}" method="post">
                {{ csrf_field() }}
        ...
        <div class="row">
            ...
            data-html="true"
            title="
            <p>você pode criar até 12 atividades já nesta tela ou pode incluir quantas quiser posteriormente 
            no botão de criar atividades </p>
            ">
            <span><i class="far fa-question-circle"></i></span>
            </a> &nbsp&nbsp&nbsp&nbsp
            <div id="addAtividade">
                <button class="btn btn-info" onclick="_mostraInputAtividade()">+ Atividades</button>
            </div> 
        </div><br>
        <div class="row">
            <div class="col-4">
                <div class="input-group mb-3" id="atividade1">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 1</span>
                    </div>
                    <input type="text" class="form-control" placeholder="Nome atividade" name='atividade1' aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade2">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 2</span>
                    </div>
                    <input type="text" class="form-control" placeholder="Nome atividade" name='atividade2' aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 3</span>
                    </div>
                    <input type="text" class="form-control" name='atividade3' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade4">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 4</span>
                    </div>
                    <input type="text" class="form-control"  name='atividade4' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade5">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 5</span>
                    </div>
                    <input type="text" class="form-control" name='atividade5' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade6">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 6</span>
                    </div>
                    <input type="text" class="form-control" name='atividade6' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade7">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 7</span>
                    </div>
                    <input type="text" class="form-control" name='atividade7' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade8">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 8</span>
                    </div>
                    <input type="text" class="form-control" name='atividade8' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade9">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 9</span>
                    </div>
                    <input type="text" class="form-control" name='atividade9' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade10">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 10</span>
                    </div>
                    <input type="text" class="form-control" name='atividade10' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade11">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 11</span>
                    </div>
                    <input type="text" class="form-control" name='atividade11' placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
            <div class="col-4">
                <div class="input-group mb-3" style="visibility: hidden;" id="atividade12">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Atividade 12</span>
                    </div>
                    <input type="text" class="form-control" name='atividade12'  placeholder="Nome atividade" aria-label="Nome atividade" aria-describedby="basic-addon1">
                  </div>
            </div>
          </div>
...
<script>
var atividade = 2
function _mostraInputAtividade() {
    event.preventDefault();
    $("#atividade" + atividade).css("visibility", "visible");
    if (atividade == 12){
        $("#addAtividade").remove()
    }else{
        atividade += 1
