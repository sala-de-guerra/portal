...
function _formataDatatableCorrecao (idTabela){
    $('#' + idTabela).DataTable({
        "order": [[ 1, "desc" ]],
        "language": {
...
$( document ).ready(function() {
     $.getJSON('/controle-laudos/correcao', function(dados){
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="/controle-laudos/cadastrarobs/${item.id}" id="formOBS${item.NU_BEM}">
                                                ...
                                                <input type="hidden" name="contratoFormatado" value="${item.BEM_FORMATADO}">
                                                    ...
                                                    <div class="form-group">
                                                    Retirar da correção ? <br>
                                                        <input type="radio" id="Sim" name="correcao" value=0>
                                                        <label for="Sim">Sim</label><br>
                                                        <input type="radio" id="Nao" name="correcao" value=1 checked>
            ...
            $(linha).appendTo('#tblCorrecao>tbody');
        ...
        _formataDatatableCorrecao("tblCorrecao")
        $('.spinnerTbl').remove()
    })
})   
