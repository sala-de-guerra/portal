...
{
    protected $table = 'TBL_PRODUTIVIDADE_CEPAT_TBL_MICROPROCESSOS';
    ...
    {
        return $this->belongsTo('App\Models\Cepat\MacroProcesso', 'IdMacroProcesso', 'IdMacro');
    }

    public function atividadeDaMicro()
    {
        return $this->hasMany('App\Models\Cepat\AtividadeDaMicro', 'idMicro', 'idMicro');
    }
