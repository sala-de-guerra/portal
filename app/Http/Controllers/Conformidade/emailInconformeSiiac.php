...
<p>%AGÊNCIA%</p><br>
    ...
    <li style="text-align: justify;"> &nbsp;&nbsp;Em continuidade ao processo de contratação supracitado, informamos que há inconformidade a ser sanada.</li></br>
        <ol>
            <li type='a' style="text-align: justify;">Portanto, em atenção ao PA anexo, informamos que a agência de contratação deve promover o envio da documentação solicitada, atentando para eventual observação abaixo. Regularizando as inconformidades e ser possível prosseguir com a contratação.</li></br>
        </ol>
        <p>%OBSERVAÇÕES%</p>
