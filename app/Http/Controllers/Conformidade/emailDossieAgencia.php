...
<html lang="pt-br">
    ...
    <title>A documentação inicial não foi enviada no fila única da agência após DOSSIE GILIE </title>
...
<p>%AGÊNCIA%</p><br>
    ...
    <li style="text-align: justify;"> &nbsp;&nbsp;Em continuidade ao processo de contratação supracitado, informamos que existe a necessidade de envio da documentação inicial no SICT2 (fila única) por parte da agência. Bem como verificar a necessidade de gerar proposta SIOPI e demais tramites de contratação.</li></br>
    <ul>
