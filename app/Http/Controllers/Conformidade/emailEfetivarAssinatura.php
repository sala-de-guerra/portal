...
<html lang="pt-br">
    ...
    <title>Proposta SIOPI gerada, vinculada e apenas falta assinatura do contrato</title>
...
<p style="color:gray; font-weight: bolder;">MENSAGEM AUTOMÁTICA. FAVOR NÃO RESPONDER.</p><br>
...
<p>%AGÊNCIA%</p><br>
    ...
    <li style="text-align: justify;"> &nbsp;&nbsp;Em continuidade ao processo de contratação supracitado, observamos que o processo no SIOPI necessita apenas da assinatura do contrato e a data prevista não foi cumprida.</li><br>
    <li style="text-align: justify;"> &nbsp;&nbsp;Assim, orientamos promover a assinatura do contrato. Além disso, contratos gerados para contratação de imóveis adjudicados via SIOPI geram guias a autenticar que devem ser observadas, evitando pendências contábeis.</li></br>
    <li style="text-align: justify;"> &nbsp;&nbsp;Em tempo, solicitamos retorno com resposta a presente solicitação e/ou justificativa até <strong style="color: red;">%DATARETORNO%</strong>. Caso contrário, poderá ser iniciado processo de distrato.</li></br>
