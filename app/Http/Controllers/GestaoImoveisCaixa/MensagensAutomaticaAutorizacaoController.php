...
class MensagensAutomaticaAutorizacaoController extends Controller
{
    ...
    public static function listagemContratosAutorizacaoImoveisPatrimoniais()
    {
        ...
        WHERE 
            ...
            AND SIMOV.[BEM_FORMATADO] != '01.4444.0191271-2' -- CONTRATO RELACIONADO INDEVIDAMENTE
            AND SIMOV.[BEM_FORMATADO] != '00.0000.1000875-0' -- CONTRATO RELACIONADO INDEVIDAMENTE
            AND SIMOV.[BEM_FORMATADO] != '01.4444.0498328-9' -- CONTRATO RELACIONADO INDEVIDAMENTE
            AND SIMOV.[BEM_FORMATADO] != '08.0252.0893794-2' -- CONTRATO RELACIONADO INDEVIDAMENTE
            AND SIMOV.[BEM_FORMATADO] != '08.5555.2625736-1' -- CONTRATO RELACIONADO INDEVIDAMENTE
        ORDER BY
            'grupoClassificacao'
            ,'tipoDeVenda'
            ,'tipoProposta'              
