...
class vendaFinanciadaController extends Controller
{
    ...
    $universoFinanciado= DB::table('TBL_VENDA_FINANCIADO')
        ...
        ->join('CUB_056_PAGAMENTOS_BOLETOS_SIMOV', DB::raw('CONVERT(VARCHAR, CUB_056_PAGAMENTOS_BOLETOS_SIMOV.NU_BEM)'), '=', DB::raw('CONVERT(VARCHAR, TBL_VENDA_FINANCIADO.NU_BEM)'))
        ->select(DB::raw('
            TBL_VENDA_FINANCIADO.[BEM_FORMATADO] as BEM_FORMATADO,
            TBL_VENDA_FINANCIADO.[NU_BEM] as NU_BEM,
            CUB_056_PAGAMENTOS_BOLETOS_SIMOV.[PAGO] as PAGAMENTO_BOLETO,
